...
# ── НАСТРОЙКИ ──────────────────────────────────────────
BOT_TOKEN = "8686309427:AAE0WQGLUocjnIjzt1n3aTjdSc34THRifYs"
...
def start(message):
    ...
    bot.send_message(
        message.chat.id,
        "👋 Добро пожаловать в *SECRETLY*\n\n"
        "Магазин streetwear и люкс одежды.\n"
        "Оригиналы · Доставка по России · Поддержка на каждом этапе\n\n"
